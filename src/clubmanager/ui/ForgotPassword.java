		...
		lblGetPasswordHint.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					{
						boolean emptyFields = (logintf.getText().equals("") || firstnametf.getText().equals("") ||
											   lastnametf.getText().equals("") || emailtf.getText().equals(""));
						
						boolean trueUserInformation = (list.get(i).getLogin().equals(logintf.getText()) &&
													   list.get(i).getFirstName().equals(firstnametf.getText()) &&
													   list.get(i).getLastName().equals(lastnametf.getText()) &&
													   list.get(i).getEmail().equals(emailtf.getText()));
						
					if (emptyFields)
					{
						JOptionPane.showMessageDialog(ForgotPassword.this,"One or more fiels are empty ", "InValid Informations",JOptionPane.ERROR_MESSAGE);	
						return;
					}
					
					else if (trueUserInformation)	
					{
						JOptionPane.showMessageDialog(ForgotPassword.this,"the hint of your password is "+list.get(i).getPassword().substring(0, 4), "Valid Informations",JOptionPane.INFORMATION_MESSAGE);		
						return;
					}
					
					else if (!trueUserInformation && i==(list.size()-1))
					{
						JOptionPane.showMessageDialog(ForgotPassword.this," the Information you provided are incorrects ", "Invalid Informations",JOptionPane.ERROR_MESSAGE);	
					  	return;
					}
			...
			try {
					...
					for (int i=0; i<list.size();i++)
					{
						boolean TrueUserInformation = (list.get(i).getLogin().equals(logintf.getText()) && list.get(i).getFirstName().equals(firstnametf.getText()) &&
								list.get(i).getLastName().equals(lastnametf.getText()) && list.get(i).getEmail().equals(emailtf.getText()))	;
					  if (TrueUserInformation)	
						{
							JOptionPane.showMessageDialog(ForgotPassword.this,"the hint of your password is "+list.get(i).getPassword().substring(0, 4), "Valid Informations",JOptionPane.INFORMATION_MESSAGE);		
							return;
						}
					else if (logintf.getText().equals("") || firstnametf.getText().equals("") ||
							lastnametf.getText().equals("") || emailtf.getText().equals(""))
					{
						JOptionPane.showMessageDialog(ForgotPassword.this," you should fill out all the fields ", "Invalid Informations",JOptionPane.ERROR_MESSAGE);	
						return;
					}
					else if (!TrueUserInformation) {
						JOptionPane.showMessageDialog(ForgotPassword.this," the Information you provided are incorrects ", "Invalid Informations",JOptionPane.ERROR_MESSAGE);	
