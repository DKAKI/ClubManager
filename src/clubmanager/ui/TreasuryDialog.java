...
public class TreasuryDialog extends JDialog {
	 ...
	 */
	public TreasuryDialog(TreasuryApp theMemberApp,
	...
	public TreasuryDialog(TreasuryApp theMemberApp, TreasuryDAO TreasuryDAO) {
		this(theMemberApp, TreasuryDAO, null, false);
	}
	...
	public TreasuryDialog() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(TreasuryDialog.class.getResource("/clubmanager/ui/pictures/logo2.png")));
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setTitle("Add Treasury");
